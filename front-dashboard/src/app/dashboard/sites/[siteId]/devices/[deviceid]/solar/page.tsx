...
export default function SolarDeviceDetailPage() {
  ...
  useEffect(() => {
    console.log('🔍 Solar Device Detail useEffect triggered with:', { siteId, deviceId });
  ...
  const exportChartData = () => {
    ...
    a.href = url;
    a.download = `solar-device-${deviceId}-stats.csv`;
  ...
  const exportHistoricalData = () => {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `solar-device-${deviceId}-historical.csv`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    window.URL.revokeObjectURL(url);
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Solar Device • {device.deviceId}</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatValue('solar', device.lastReading?.value)}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatValue('solar', device.threshold)}
                </p>
              </div>
